...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/article/changeOverhead","/article/changeType","/article/delete/**","/edit/**","/manage","/comment/reply","/sort/add","/sort/user","/article/add","/article/check/**","/article/update").authenticated()//任何经过身份验证的用户才能访问
                .and()
                .formLogin()
                .loginPage("/logoreg")
